  ...
  jQuery(document).ready(function ($) {
    ...
    function openPopup({ imgSrc, title, price, card, content, gallery }) {
      ...
      const contentsContainer = document.querySelector(
        ".popup-product-info_description"
      );
    ...
    if (track) {
      ...
      function createInfiniteScroll() {
        ...
        const neededCopies =
          Math.ceil((screenWidth * speedFactor) / totalWidth) + 3;
    ...
    class PopupManager {
      ...
      openFormPopup(formType = "default") {
        ...
        switch (formType) {
          case "kp":
            this.popupTitle.textContent = "Оставить заявку";
            this.popupSubmitBtn.textContent = "Оставить заявку";
            break;
          case "callback":
            this.popupTitle.textContent = "Оставить заявку";
            this.popupSubmitBtn.textContent = "Оставить заявку";
