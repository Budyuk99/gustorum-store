    ...
    <header>
        <div class="container header-inner">
            ...
            <div class="header-inner_second-block">
                <a href="#" class="header-inner_second__make-call" data-popup="call" data-popup-type="callback">Оставить заявку</a>
            </div>
        </div>
        ...
        <div class="mobile-menu">
            ...
            <div class="mobile-menu__contacts">
                ...
                <a href="#" class="mobile-menu__call-btn" data-popup="call" data-popup-type="callback">Оставить заявку</a>
            </div>
        </div>
